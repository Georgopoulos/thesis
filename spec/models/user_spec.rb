...
describe User do
	...
	before { @user = User.new(email: "user@example.com", password: 'foobar',
													 password_confirmation: 'foobar', fullname: "Example User", 
													 phone: "+306900000000", address: "Somewhere 66") }
	...
	describe "when name is less than 5 characters" do
		before { @user.fullname = "a" * 4 }
		it { should_not be_valid }
	end
